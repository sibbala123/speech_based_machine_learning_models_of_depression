...
# ====================================================================
# 2) MODEL ARCHITECTURE (MATCHING TRAINING SCRIPT)
# ====================================================================
...
if __name__ == "__main__":
    print("Starting Language Model Final Test Evaluation (using saved weights)...")
    ...
    try:
        ...
        print(f"Loaded Best Hparams: Fusion={best_hparams['fusion']}, Hidden={best_hparams['hidden_size']}, Dropout={best_hparams['dropout']:.2f}")
    except FileNotFoundError:
        print(f"Error: Hyperparameter file not found at {BEST_HYPERPARAM_PATH}. Please run the training script first to generate this file.")
        sys.exit(1)
    ...
    final_model = ContextualLSTM(
        ...
        bidirectional=True  # Matching training script
    ).to(DEVICE)
    ...
    try:
        ...
        print(f"Error: Model weights not found at {BEST_MODEL_PATH}. Please run the training script first to generate this file.")
        sys.exit(1)
    ...
    final_test_summary = {
        "model": "Language Contextual LSTM (Enhanced)",
